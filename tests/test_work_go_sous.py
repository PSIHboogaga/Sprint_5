...
class TestWorkGoSous:
    def test_work_go_sous(self, driver):
        ...
        WebDriverWait(driver, 10).until(
            expected_conditions.element_to_be_clickable((By.XPATH, ".//span[text() = 'Соусы']")))  # подождали пока будут кликабельны соусы (важная тема для слабых ПК и медленного интернета)
