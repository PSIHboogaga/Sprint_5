...
class TestWorkGoNachinki:
    def test_work_go_nachinki(self, driver):
        ...
        assert driver.find_element(By.CLASS_NAME, "tab_tab__1SPyG tab_tab_type_current__2BEPc pt-4 pr-10 pb-4 pl-10 noselect").is_displayed()  #<div class="tab_tab__1SPyG tab_tab_type_current__2BEPc pt-4 pr-10 pb-4 pl-10 noselect"><span class="text text_type_main-default">Начинки</span></div>