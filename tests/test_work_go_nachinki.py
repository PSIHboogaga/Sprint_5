...
class TestWorkGoNachinki:
    def test_work_go_nachinki(self, driver):
        ...
        WebDriverWait(driver, 10).until(
            expected_conditions.element_to_be_clickable(StellarburgersLocators.Button_nachinki)) # подождали пока будут кликабельны начинки (важная тема для слабых ПК и медленного интернета)
