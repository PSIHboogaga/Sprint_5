...
class TestExit:
    def test_work_go_sous(self, driver):
        ...
        driver.find_element(By.XPATH, "//div/main/section[1]/div[1]/div[2]").click()  # Клик кнопки sous
        assert driver.find_element(By.XPATH, "//div/main/section[1]/div[2]/ul[2]/a[1]/img").is_displayed()  #